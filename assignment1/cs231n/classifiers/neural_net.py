...
class TwoLayerNet(object):
    ...
    In other words, the network has the following architecture:tso
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        Returns:
        If y is None, return a matrix scores of shape (N, C) where scores[t, c] is
    ...
    def train(self, X, y, X_val, y_val,
        ...
        for it in range(num_iters):
            ...
            #See numpy doc for initialization of an existing array of size n and only taking
            #size i -- new size = n-i
            ...
            #see lecture notes
            #the new weights are pultiplied by the grads (shows in which direction the changes need to be made
            #in order to minimize the loss function) with a small step size
    ...
    def predict(self, X):
        ...
        #Just do the forward computation and output the highest probability
